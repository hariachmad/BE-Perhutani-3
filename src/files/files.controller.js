...
let FilesController = (() => {
    let _classDecorators = [(0, common_1.Controller)('files')];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _instanceExtraInitializers = [];
    let _getFiles_decorators;
    var FilesController = _classThis = class {
        getFiles() {
            const directoyPath = (0, path_1.join)(__dirname, '..', '..', 'client');
            const files = (0, fs_1.readdirSync)(directoyPath);
            return files;
        }
        constructor() {
    ...
    (() => {
        ...
        _getFiles_decorators = [(0, common_1.Get)()];

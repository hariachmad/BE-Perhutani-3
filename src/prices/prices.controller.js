...
let PricesController = (() => {
    let _classDecorators = [(0, common_1.Controller)('prices')];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _instanceExtraInitializers = [];
    let _findAll_decorators;
    var PricesController = _classThis = class {
        constructor(priceService) {
            this.priceService = (__runInitializers(this, _instanceExtraInitializers), priceService);
        }
        findAll() {
